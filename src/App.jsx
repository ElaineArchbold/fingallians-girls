...
const WHATSAPP_LINK     = WHATSAPP_2015;
const APP_SQUAD         = "2015";
const APP_SQUAD_LABEL   = "Fingallians 2015 Girls";
const APP_SQUAD_SHORT   = "2015 Girls";
          ...
          <div className="hdr">
            <div className="hdr-row">
              ...
              <div style={{minWidth:0}}>
                ...
                <div className="hdr-sub">Fingallians 2015 Girls · Summer Challenge 2026</div>
...
function ContactForm({ player }) {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      formData.append("squad", "Fingallians 2015 Girls");
    ...
    <div className="home-wrap">
      ...
      <div style={{fontSize:24,marginBottom:6}}>📱🏑⚽</div>
        ...
        <div style={{fontSize:13,opacity:0.85,lineHeight:1.6,marginBottom:14}}>
          Got a video or photo of your girl putting in the work? We'd love to see it! Send it on to the coaches in the WhatsApp group.
...
function ShareProgressButton({ player, checks }) {
  ...
  const lines = [
    `🏑⚽ Fingallians 2015 Girls Summer Challenge 2026`,
    ``,
        ...
        return (
          <div style={{display:"flex",gap:10,marginTop:12,flexWrap:"wrap"}}>
            {[
              ...
              ...(improved.length?[{label:"Improved",val:`${improved.length} girls`,color:"#2e7d32"}]:[]),
            ].map(stat => (
...
function WAMessageGenerator({ allPlayers, ptsMap }) {
  ...
  const message = [
    `🏑⚽ Fingallians 2015 Girls – Challenge Update · Week ${currentWeek} of 8`,
    ``,
    `Leaderboard so far:`,
...
function downloadCSV(allPlayers, ptsMap, weeklyMap) {
  ...
  a.href = url;
  a.download = `fingallians-2015-girls-challenge-${new Date().toISOString().slice(0,10)}.csv`;
  a.click();
  ...
  return (
    <div className="admin-wrap">
      <div style={{background:"linear-gradient(135deg,var(--g),#4a0a0e)",borderRadius:"var(--radius)",padding:"16px 18px",marginBottom:14,color:"#fff",position:"relative",overflow:"hidden"}}>
        ...
        <div style={{fontSize:12,opacity:0.7,marginTop:2}}>Fingallians 2015 Girls · Week {currentWeek} of 8 · Summer Challenge 2026</div>
